...
class EvaluateClassifiersEmbedding {
	
	public EvaluateClassifiersEmbedding() {
	}
	...
	public static void main(String [] args) throws Exception {
		...
		EvaluateClassifiersEmbedding task = new EvaluateClassifiersEmbedding();
		...
		PairClassifier eeCls = new EventEventRelationClassifier("te3", "liblinear"
				,"wembedconv", "3000", "./data/embedding/te3-ee-eval-embedding-300.exp0.csv"
				);
